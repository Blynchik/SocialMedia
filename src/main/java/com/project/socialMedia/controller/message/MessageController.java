...
public class MessageController extends AbstractMessageController{
    ...
    @Operation(summary = "Метод позволяет отправить сообщение другому пользователю. " +
    ...
    @Operation(summary = "Метод возвращает входящие сообщения пользователя " +
    ...
    @Operation(summary = "Метод возвращает исходящие сообщения пользователя " +
            "в порядке от последнего к самым дальним по времени " +
            "или пустой список, если их нет. " +
            "Ответ OK.")
    @GetMapping("/outgoing")
