...
public class RegistrationAndAuthController extends AbstractUserController {
    ...
    @Operation(summary = "Создает нового пользователя с помощью данных из объекта CreateAppUserDTO. " +
    ...
    @Operation(summary = "Метод для аутентификации пользователя. " +
    ...
    @Operation(summary = "Метод контроллера \"/logout\" выполняет выход пользователя из системы. " +
